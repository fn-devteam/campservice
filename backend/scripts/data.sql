INSERT INTO Campservice.customer (name,fantasy_name,active,person_type,cpf_cnpj,state_registration,city,state,phone_number,cell_number,email_address,contact_person,zip_code,address,district,obs,registration_date,profile) VALUES
	 ...
	 ('JOSE DARIO DE OLIVEIRA','JOSE DARIO DE OLIVEIRA',1,'FISICA',NULL,NULL,'1059',NULL,NULL,NULL,'','',NULL,'A',NULL,NULL,NULL,NUL'CLIENTE'),
...
INSERT INTO Campservice.vehicle (license_plate,brand,model,color,`year`,current_km,km_oil_change,km_last_oil_change,km_change_timing_belt,`km_last_ timing_belt_change`) VALUES
	 ...
	 ('DDB-7991','VW','saveiro','.',2001,0,0,0,0,0),
	 ('QQQ-4444','.','.','.',0,0,0,0,0,0),
	 ('MKD-8515','Chevrollet','Prisma 1.4','preto   ',2012,0,0,0,0,0),
	 ('MFG-2333','Fiat','Palio 1.4 ','vermelho',2010,0,0,0,0,0),
...
INSERT INTO Campservice.vehicle (license_plate,brand,model,color,`year`,current_km,km_oil_change,km_last_oil_change,km_change_timing_belt,`km_last_ timing_belt_change`) VALUES
	 ...
	 ('MBX-5541','Vollksvagem','Saveiro 1.8','Prata',2006,0,0,0,0,0),
	 ('PFN-9225','GM','Monza','bordo',1992,0,0,0,0,0),
	 ('MGQ-4579','Ford','Fiesta','Preto',2009,0,0,0,0,0),
	 ('LXT-7306','VW','Golf antigo','Verde',1992,0,0,0,0,0),
...
INSERT INTO Campservice.vehicle (license_plate,brand,model,color,`year`,current_km,km_oil_change,km_last_oil_change,km_change_timing_belt,`km_last_ timing_belt_change`) VALUES
	 ...
	 ('MEW-9375','peg','307 ','prata',2008,0,0,0,0,0),
	 ('CIJ-8485','gm','vectra','azul',2005,0,0,0,0,0),
	 ('MZB-5183','renaut','clio sedan','preto',2000,0,0,0,0,0),
	 ('LXS-3407','vw','gol','branco',1998,0,0,0,0,0),
