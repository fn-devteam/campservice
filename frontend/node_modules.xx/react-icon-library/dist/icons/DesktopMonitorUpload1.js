...
export default function DesktopMonitorUpload1(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M6.749,6.75h-3a1.5,1.5,0,0,0-1.5,1.5V18a1.5,1.5,0,0,0,1.5,1.5h16.5a1.5,1.5,0,0,0,1.5-1.5V8.25a1.5,1.5,0,0,0-1.5-1.5h-3"/>
			...
			<polyline className="a" points="14.999 3.75 11.999 0.75 8.999 3.75"/>
			<line className="a" x1="11.999" y1="0.75" x2="11.999" y2="12.75"/>
		</svg>);
}
//# sourceMappingURL=DesktopMonitorUpload1.js.map