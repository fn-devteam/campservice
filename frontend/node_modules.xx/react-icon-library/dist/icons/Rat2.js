...
export default function Rat2(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M19.055,16.172A18.965,18.965,0,0,0,19.5,12a6.019,6.019,0,0,0-.45-2.25,4.456,4.456,0,0,0,4.2-4.5,4.5,4.5,0,0,0-9,0v.3A11.579,11.579,0,0,0,12,5.25a11.579,11.579,0,0,0-2.25.3v-.3a4.42,4.42,0,0,0-4.5-4.5,4.42,4.42,0,0,0-4.5,4.5,4.456,4.456,0,0,0,4.2,4.5A6.019,6.019,0,0,0,4.5,12a18.965,18.965,0,0,0,.444,4.172"/>
