...
export default function OfficeWorkWireless(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M9.751,23.25a1.5,1.5,0,0,1-1.344-.829l-.67-1.342A1.491,1.491,0,0,0,6.4,20.25H4.5A1.5,1.5,0,0,1,3,18.75v-6A1.5,1.5,0,0,1,5.331,11.5l1.116.744a3,3,0,0,0,1.665.5H9.749a1.5,1.5,0,1,1,0,3H8.112A5.964,5.964,0,0,1,6,15.366V17.25h.4a4.478,4.478,0,0,1,4.025,2.487l.671,1.342a1.5,1.5,0,0,1-1.34,2.171Z"/>
...
//# sourceMappingURL=OfficeWorkWireless.js.map