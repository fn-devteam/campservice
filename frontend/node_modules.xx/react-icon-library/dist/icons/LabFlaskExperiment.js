...
export default function LabFlaskExperiment(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M15.749,8.25V.75h-7.5v7.5L1.512,18.615A3,3,0,0,0,4.028,23.25H19.971a3,3,0,0,0,2.516-4.635Z"/>
...
//# sourceMappingURL=LabFlaskExperiment.js.map