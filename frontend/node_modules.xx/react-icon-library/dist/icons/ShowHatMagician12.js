...
export default function ShowHatMagician12(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<path className="cls-1" d="M8.856,7.651c1-.1,2.054-.151,3.144-.151,6.351,0,11.5,1.791,11.5,4s-5.149,4-11.5,4S.5,13.709.5,11.5c0-1,1.051-1.911,2.788-2.611"/>
			<ellipse className="cls-1" cx={12} cy="11.5" rx={7} ry={2}/>
			<path className="cls-1" d="M18.5,16.5c0,1.105-2.634,2-6.5,2s-6.5-.895-6.5-2"/>
			...
			<polygon className="cls-1" points="6 8.5 7 6.5 9 5.5 7 4.5 6 2.5 5 4.5 3 5.5 5 6.5 6 8.5"/>
			<line className="cls-1" x1="23.5" y1="0.5" x2={12} y2="5.5"/>
		</svg>);
}
//# sourceMappingURL=ShowHatMagician12.js.map