...
export default function Skull1(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<title>skull-1</title>
			<path className="cls-1" d="M12,.5A9.5,9.5,0,0,0,2.5,10v7.5a2,2,0,0,0,2,2v2a2,2,0,0,0,2,2h11a2,2,0,0,0,2-2v-2a2,2,0,0,0,2-2V10A9.5,9.5,0,0,0,12,.5Z"/>
...
//# sourceMappingURL=Skull1.js.map