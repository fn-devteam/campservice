...
export default function ScienceDna2(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M23.136,9.348,20.484,12A6,6,0,0,1,12,3.515L14.651.863"/>
			<path className="a" d="M9.347,23.137,12,20.485A6,6,0,0,0,3.514,12L.862,14.652"/>
			...
			<path className="a" d="M.862,14.652,3.514,12A6,6,0,1,1,12,20.485L9.347,23.137"/>
...
//# sourceMappingURL=ScienceDna2.js.map