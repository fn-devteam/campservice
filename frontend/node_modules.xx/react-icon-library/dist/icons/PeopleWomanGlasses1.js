...
export default function PeopleWomanGlasses1(props) {
    return (<svg id="Bold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
			...
			<circle cx={14} cy="8.75" r={1}/>
			<circle cx={10} cy="8.75" r={1}/>
			<path d="M10.38,11.364a.637.637,0,0,0,.316.719,2.923,2.923,0,0,0,2.61,0,.64.64,0,0,0-.306-1.2H11A.64.64,0,0,0,10.38,11.364Z"/>
			<path d="M22.533,19.218h0a12.124,12.124,0,0,0-2.683-1.509,14.77,14.77,0,0,0,2.025-1.261.5.5,0,0,0,.032-.759C18.715,12.721,19.484,7.882,19.5,7.75a7.449,7.449,0,0,0-1.15-3.972,3.2,3.2,0,0,0,.4-1.528C18.75,0,16.555,0,15.5,0a4.979,4.979,0,0,0-2.185.373,7.1,7.1,0,0,0-2.631,0A4.977,4.977,0,0,0,8.5,0C7.445,0,5.25,0,5.25,2.25a3.211,3.211,0,0,0,.407,1.542,7.587,7.587,0,0,0-1.15,4.042c.008.048.787,4.878-2.413,7.855a.5.5,0,0,0,.032.759,14.775,14.775,0,0,0,2.024,1.26,12.113,12.113,0,0,0-2.683,1.51A2.464,2.464,0,0,0,.5,21.2v2.3A.5.5,0,0,0,1,24H23a.5.5,0,0,0,.5-.5V21.2A2.467,2.467,0,0,0,22.533,19.218ZM6.75,2.25c0-.383.011-.654,1.085-.728C10.5,1.339,10.25,2,10.25,2.25A1.752,1.752,0,0,1,8.5,4,1.777,1.777,0,0,1,6.75,2.25Zm10.5,0A1.789,1.789,0,0,1,15.5,4a1.752,1.752,0,0,1-1.75-1.75c0-.462.064-.7,1.407-.742C17.242,1.448,17.25,1.8,17.25,2.25ZM11.8,5.68a.25.25,0,0,1,.392,0A5.451,5.451,0,0,0,16.26,7.745.251.251,0,0,1,16.5,8V9.75a4.5,4.5,0,0,1-9,0V8a.25.25,0,0,1,.239-.25A5.453,5.453,0,0,0,11.8,5.68Zm4.084,11.382a.249.249,0,0,1,.2.326c-1.184,3.573-3,3.89-3.968,4.4a.252.252,0,0,1-.23,0c-3.4-1.7-3.732-3.352-4-4.422a.254.254,0,0,1,.034-.2.25.25,0,0,1,.169-.109A25.183,25.183,0,0,1,15.888,17.062Z"/>
		</svg>);
}
//# sourceMappingURL=PeopleWomanGlasses1.js.map