...
export default function Pencil22(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M22.191,1.811a3.631,3.631,0,0,0-5.157.035L2.569,16.307l-1.82,6.94,6.942-1.819L22.156,6.967A3.628,3.628,0,0,0,22.191,1.811Z"/>
...
//# sourceMappingURL=Pencil22.js.map