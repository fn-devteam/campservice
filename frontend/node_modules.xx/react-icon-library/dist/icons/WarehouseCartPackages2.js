...
export default function WarehouseCartPackages2(props) {
    return (<svg id="Bold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
			...
			<rect x={7} y="7.75" width={7} height={7} rx={1} ry={1}/>
			<rect x="15.5" y="7.75" width={7} height={7} rx={1} ry={1}/>
			<rect x={11} y="1.25" width={8} height={5} rx={1} ry={1}/>
...
//# sourceMappingURL=WarehouseCartPackages2.js.map