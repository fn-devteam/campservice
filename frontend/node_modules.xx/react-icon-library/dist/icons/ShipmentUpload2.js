...
export default function ShipmentUpload2(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<path className="cls-1" d="M12.9,23.314a1,1,0,0,1-.8.013L1.115,18.751A1,1,0,0,1,.5,17.828V6.15a1,1,0,0,1,.6-.917L11.6.668a1,1,0,0,1,.8,0L22.9,5.233a1,1,0,0,1,.6.917v11.7a1,1,0,0,1-.586.911Z"/>
...
//# sourceMappingURL=ShipmentUpload2.js.map