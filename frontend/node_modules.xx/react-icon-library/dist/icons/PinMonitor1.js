...
export default function PinMonitor1(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<path className="cls-1" d="M20.5,13.5v6a1,1,0,0,1-1,1H1.5a1,1,0,0,1-1-1V7.5a1,1,0,0,1,1-1h12"/>
			<path className="cls-1" d="M19.5.5a4,4,0,0,1,4,4c0,1.781-2.6,5.241-3.608,6.514a.5.5,0,0,1-.784,0C18.1,9.74,15.5,6.281,15.5,4.5A4,4,0,0,1,19.5.5Z"/>
			<circle className="cls-1" cx="19.5" cy="4.5" r="1.5"/>
		</svg>);
}
//# sourceMappingURL=PinMonitor1.js.map