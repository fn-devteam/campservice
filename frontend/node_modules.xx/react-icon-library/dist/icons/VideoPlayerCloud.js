...
export default function VideoPlayerCloud(props) {
    return (<svg id="Bold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
			...
			<path d="M24,9a6.007,6.007,0,0,0-5.642-5.989.252.252,0,0,1-.178-.091A8,8,0,0,0,4.3,5.838a.25.25,0,0,1-.217.182,4.5,4.5,0,0,0-.373,8.91A.251.251,0,0,0,4,14.684V13.146a.248.248,0,0,0-.182-.24A2.5,2.5,0,0,1,4.9,8.032a.993.993,0,0,0,.757-.181,1.006,1.006,0,0,0,.4-.67,6,6,0,0,1,10.873-2.6,1,1,0,0,0,.873.427,4,4,0,0,1,2.315,7.388.249.249,0,0,0-.117.212v1.686a.249.249,0,0,0,.348.23A6.007,6.007,0,0,0,24,9Z"/>
			<path d="M18.5,12.5A1.5,1.5,0,0,0,17,11H7a1.5,1.5,0,0,0-1.5,1.5v10A1.5,1.5,0,0,0,7,24H17a1.5,1.5,0,0,0,1.5-1.5Zm-4.231,4.27a.846.846,0,0,1,0,1.461l-3.7,2.156h0a.838.838,0,0,1-1.255-.731V15.344a.837.837,0,0,1,1.255-.731Z"/>
		</svg>);
}
//# sourceMappingURL=VideoPlayerCloud.js.map