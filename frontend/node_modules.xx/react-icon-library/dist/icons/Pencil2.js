...
export default function Pencil2(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<polygon className="cls-1" points="7 21.5 0.5 23.5 2.5 17 15.33 4.169 19.83 8.669 7 21.5"/>
			<path className="cls-1" d="M15.33,4.169l3.086-3.086a2.007,2.007,0,0,1,2.828,0l1.672,1.672a2,2,0,0,1,0,2.828L19.83,8.669"/>
...
//# sourceMappingURL=Pencil2.js.map