...
export default function ScienceDna1(props) {
    return (<svg id="Light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;}',
			...
			<path className="cls-1" d="M6.868,23.131A7.952,7.952,0,0,0,6.7,17.3,8.11,8.11,0,0,1,8.464,8.46a8.2,8.2,0,0,1,6.673-2.339"/>
			<path className="cls-1" d="M9.137,17.9a8.206,8.206,0,0,0,6.4-2.365A8.114,8.114,0,0,0,17.3,6.692,7.949,7.949,0,0,1,17.129.869"/>
...
//# sourceMappingURL=ScienceDna1.js.map