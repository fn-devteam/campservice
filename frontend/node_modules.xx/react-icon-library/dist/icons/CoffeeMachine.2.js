...
export default function CoffeeMachine2(props) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} {...props}>
        ...
        __html: '.a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}',
			...
			<path className="a" d="M22.5,21.75a1.5,1.5,0,0,0-1.5-1.5H3a1.5,1.5,0,1,0,0,3H21A1.5,1.5,0,0,0,22.5,21.75Z"/>
			<polygon className="a" points="20.999 20.25 2.999 20.25 2.999 6.75 11.999 6.75 20.999 6.75 20.999 20.25"/>
			<line className="a" x1="10.499" y1="9.75" x2="10.499" y2="11.25"/>
			<line className="a" x1="13.499" y1="9.75" x2="13.499" y2="11.25"/>
			<path className="a" d="M15.749,14.25c0,2.071,0,5.25-3.75,5.25-3,0-3.216-2.695-3.632-4.313a.751.751,0,0,1,.727-.937Z"/>
			<path className="a" d="M15.749,14.25h0A2.25,2.25,0,0,1,18,16.5h0"/>
			<rect className="a" x="1.499" y="0.75" width={21} height={6} rx={1} ry={1}/>
...
//# sourceMappingURL=CoffeeMachine.2.js.map